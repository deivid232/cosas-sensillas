...
<main id="wrapper" class="d-flex flex-column">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container ">
                ...
                <div class="collapse navbar-collapse navbar-right justify-content-end " id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link font-weight-medium" href="#inicio">Inicio</a>
                        </li>
                        <li class="nav-item">
    ...
    <!--[2] Breadcrumbs-->
    <a name="inicio"></a>
  <section id="head-portada" data-type="parallax-seccion" data-speed="10">
    <div class="jumbotron portada-general">
      <div class="row" id="" >
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6 texto-portada">
          <h1 class="text-center mb-1 font-weight-light ">Servicio jurídico de confianza</h1><br>
            <div class=" col-lg-10 container d-flex flex-column justify-content-center align-items-center">
              <h3 class="text-center mb-1 font-weight-light">
                    <br>Expertos en exigir tus derecho como consumidor.</h3>
                    <p class="text-center mb-1 font-weight-light">
                    Consulta gratuitamente  con un abogado. <br> </p>
                  <button type="button" class="btn btn-lg btn-primary rounded font-weight-light bonton-estilo-1" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Contáctanos</button>
            </div>
        </div>

        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6 foto-portada">
          <img src="imagenes/abogado-sin-fondo.png" class="img-fluid foto-estilo" alt="" style="width:100%;">
        </div>
    </div>
    </div>
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <section id="welcome-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl img-col"><img src="imagenes/img_home_derechos.jpg" class="img-fluid imagen-informacion" alt=""></div>
                <div class="col-xl info-col">
                    <h5 class="mb-3">La ley de protección al consumidor establece una serie de herramientas con el fin de repara el daño causado por un mal servicio o producto.</h5>
                    <p class="mb-3 text-info-col">Como consumidor puedes solicitar el cobro de una multa al proveedor mas una indemnización por
                       los perjuicios ocasionados a tu persona o familiares.
                ...
                <div class="col-md col-contact image-fluid" style="background-image: url(imagenes/contacto3.jpg); background-size: 100%; background-repeat: no-repeat; background-size: cover;">
                  <div class="row justify-content-center">
                    <div class="form-contact col-md-10">
                        ...
                        <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="enviar.php" >
                            <div class="row-input d-flex transparente text-white">
                            ...
                            <div class=" transparente text-white">
                            ...
                            <div class="form-group text-center">
                                 <input type="submit" id="submit" name="submit" class="btn btn-primary btn-lg rounded bonton-estilo-2" value="enviar" />
                            </div>
                        </form>
                    </div>
                  </div>
